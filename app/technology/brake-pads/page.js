        ...
        <section className="product-detail">
          <div className="product-detail-image">
            <div className="product-detail-image-box">
              <img src="/4.avif" alt="Brake Pads" className="product-detail-img" />
            </div>
            <h2 className="quality-heading">Specification  ++</h2>
            <div className="quality-main">
              <div className="one-sp"><p className="spec-head">Material</p><p className="spec-para">Semi-metallic compound</p></div>
              <div className="one-sp"><p className="spec-head">Fitment</p><p className="spec-para">Most passenger cars</p></div>
              <div className="one-sp"><p className="spec-head">Performance</p><p className="spec-para">Low dust, high stopping power</p></div>
              <div className="one-sp"><p className="spec-head">Warranty</p><p className="spec-para">6 months</p></div>
            </div>
          </div>

          <div className="product-detail-info">
            <h1 className="product-detail-title">Brake Pads</h1>
            <div className="product-detail-rating-row">
              <span className="product-detail-stars">★★★★★</span>
              <span className="product-detail-score">4.7</span>
              <span className="product-detail-reviews">| 10 reviews</span>
            </div>
            <p className="product-detail-price">$80.00</p>
            ...
            <div className="product-detail-section">
              ...
              <p className="product-detail-section-text">Reliable brake pads engineered for consistent stopping and long life.</p>
            </div>
            ...
            <div className="product-detail-section">
              ...
              <p className="product-detail-section-text-01">Quality brake pads designed to reduce noise and vibration with improved braking performance.</p>
            </div>
