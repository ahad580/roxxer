        ...
        <section className="product-detail">
          <div className="product-detail-image">
            <div className="product-detail-image-box">
              <img src="/2.avif" alt="GPS Tracker" className="product-detail-img" />
            </div>
            <h2 className="quality-heading">Specification  ++</h2>
            <div className="quality-main">
              <div className="one-sp"><p className="spec-head">Connectivity</p><p className="spec-para">GPS + GSM</p></div>
              <div className="one-sp"><p className="spec-head">Battery</p><p className="spec-para">Up to 7 days standby</p></div>
              <div className="one-sp"><p className="spec-head">Accuracy</p><p className="spec-para">±5 meters</p></div>
              <div className="one-sp"><p className="spec-head">Mount</p><p className="spec-para">Magnetic / Adhesive</p></div>
            </div>
          </div>

          <div className="product-detail-info">
            <h1 className="product-detail-title">GPS Tracker</h1>
            <div className="product-detail-rating-row">
              <span className="product-detail-stars">★★★★★</span>
              <span className="product-detail-score">4.9</span>
              <span className="product-detail-reviews">| 12 reviews</span>
            </div>
            <p className="product-detail-price">$100.00</p>
            ...
            <div className="product-detail-section">
              ...
              <p className="product-detail-section-text">Compact GPS tracker for real-time vehicle tracking and theft recovery.</p>
            </div>
            ...
            <div className="product-detail-section">
              ...
              <p className="product-detail-section-text-01">Reliable GPS tracker with web and mobile tracking, geofencing and history export.</p>
            </div>
