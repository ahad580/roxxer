...
export default function WheelRimPage(){
        ...
        <section className="product-detail">
          <div className="product-detail-image">
            <div className="product-detail-image-box">
              <img src="/img1.jpeg" alt="Wheel Rim" className="product-detail-img" />
            </div>
            <h2 className="quality-heading">Specification  ++</h2>
            <div className="quality-main">
              <div className="one-sp"><p className="spec-head">Material</p><p className="spec-para">Alloy / Steel</p></div>
              <div className="one-sp"><p className="spec-head">Size</p><p className="spec-para">15" - 20"</p></div>
              <div className="one-sp"><p className="spec-head">Finish</p><p className="spec-para">Matte / Gloss</p></div>
              <div className="one-sp"><p className="spec-head">Fitment</p><p className="spec-para">Vehicle specific</p></div>
            </div>
          </div>

          <div className="product-detail-info">
            <h1 className="product-detail-title">Wheel Rim</h1>
            <div className="product-detail-rating-row">
              ...
              <span className="product-detail-reviews">| 6 reviews</span>
            </div>
            <p className="product-detail-price">$149.00</p>
            ...
            <div className="product-detail-section">
              ...
              <p className="product-detail-section-text">Stylish wheel rim designed for performance and looks.</p>
            </div>
            ...
            <div className="product-detail-section">
              ...
              <p className="product-detail-section-text-01">High-quality rim that balances strength and weight for better handling.</p>
            </div>
