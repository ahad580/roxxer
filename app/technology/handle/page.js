                ...
                <section className="product-detail">
                    <div className="product-detail-image">
                        <div className="product-detail-image-box">
                            <img src="/handle.avif" alt="Handle" className="product-detail-img" />
                        </div>
                        <h2 className="quality-heading">Specification  ++</h2>
                        <div className="quality-main">

                            <div className="one-sp">
                                <p className="spec-head">Material</p>
                                <p className="spec-para">Aluminium alloy, corrosion-resistant finish</p>
                            </div>

                            <div className="one-sp">
                                <p className="spec-head">Finish</p>
                                <p className="spec-para">Matte black / Chrome options</p>
                            </div>

                            <div className="one-sp">
                                <p className="spec-head">Fitment</p>
                                <p className="spec-para">Universal fit for most vehicle doors</p>
                            </div>

                            <div className="one-sp">
                                <p className="spec-head">Durability</p>
                                <p className="spec-para">Tested for heavy use and weather resistance</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="product-detail-info">
                        <h1 className="product-detail-title">Handle</h1>
                        ...
                        <p className="product-detail-price">$200.00</p>
                        ...
                        <div className="product-detail-section">
                            ...
                            <p className="product-detail-section-text">
                                High-quality handle engineered for long-lasting performance and smooth operation.
                            </p>
                        </div>
                        ...
                        <div className="product-detail-section">
                            ...
                            <p className="product-detail-section-text">
                                ...
                                support if you receive a damaged or faulty item.
                            </p>
                        </div>
                        <div className="product-detail-section">
                            <h3 className="product-detail-section-title">
