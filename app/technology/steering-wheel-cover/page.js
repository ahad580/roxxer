...
export default function SteeringWheelCoverPage(){
        ...
        <section className="product-detail">
          <div className="product-detail-image">
            <div className="product-detail-image-box">
              <img src="/3.avif" alt="Steering Wheel Cover" className="product-detail-img" />
            </div>
            <h2 className="quality-heading">Specification  ++</h2>
            <div className="quality-main">
              <div className="one-sp"><p className="spec-head">Material</p><p className="spec-para">Leatherette / Fabric</p></div>
              <div className="one-sp"><p className="spec-head">Fitment</p><p className="spec-para">Universal fit guide</p></div>
              <div className="one-sp"><p className="spec-head">Comfort</p><p className="spec-para">Cushioned grip for long drives</p></div>
              <div className="one-sp"><p className="spec-head">Maintenance</p><p className="spec-para">Wipe clean</p></div>
            </div>
          </div>

          <div className="product-detail-info">
            <h1 className="product-detail-title">Steering Wheel Cover</h1>
            <div className="product-detail-rating-row">
              <span className="product-detail-stars">★★★★★</span>
              <span className="product-detail-score">5.0</span>
              <span className="product-detail-reviews">| 4 reviews</span>
            </div>
            <p className="product-detail-price">$99.00</p>
            ...
            <div className="product-detail-section">
              ...
              <p className="product-detail-section-text">Durable cover for better grip and interior protection.</p>
            </div>
            ...
            <div className="product-detail-section">
              ...
              <p className="product-detail-section-text-01">Stylish and comfortable steering wheel cover that improves grip and saves your steering wheel from wear.</p>
            </div>
