...
export default function LedHeadlightBulbsPage(){
        ...
        <section className="product-detail">
          <div className="product-detail-image">
            <div className="product-detail-image-box">
              <img src="/img1.jpeg" alt="LED Headlight Bulbs" className="product-detail-img" />
            </div>
            <h2 className="quality-heading">Specification  ++</h2>
            <div className="quality-main">
              <div className="one-sp"><p className="spec-head">Brightness</p><p className="spec-para">Up to 3000 lumens</p></div>
              <div className="one-sp"><p className="spec-head">Lifetime</p><p className="spec-para">Up to 30,000 hours</p></div>
              <div className="one-sp"><p className="spec-head">Fitment</p><p className="spec-para">Various bulbs sizes</p></div>
              <div className="one-sp"><p className="spec-head">Cooling</p><p className="spec-para">Built-in fan / passive</p></div>
            </div>
          </div>

          <div className="product-detail-info">
            <h1 className="product-detail-title">LED Headlight Bulbs</h1>
            ...
            <div className="product-detail-section">
              ...
              <p className="product-detail-section-text">High-efficiency LED bulbs for brighter, longer-lasting illumination.</p>
            </div>
            ...
            <div className="product-detail-section">
              ...
              <p className="product-detail-section-text-01">Premium LED bulbs designed for a brighter, cooler white light and improved road visibility.</p>
            </div>
