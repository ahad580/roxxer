        ...
        <section className="product-detail">
          <div className="product-detail-image">
            <div className="product-detail-image-box">
              <img src="/10.avif" alt="Car Battery" className="product-detail-img" />
            </div>
            <h2 className="quality-heading">Specification  ++</h2>
            <div className="quality-main">
              <div className="one-sp"><p className="spec-head">Capacity</p><p className="spec-para">60Ah - 100Ah</p></div>
              <div className="one-sp"><p className="spec-head">Type</p><p className="spec-para">Lead-acid / AGM</p></div>
              <div className="one-sp"><p className="spec-head">Warranty</p><p className="spec-para">12 months</p></div>
              <div className="one-sp"><p className="spec-head">Maintenance</p><p className="spec-para">Low maintenance</p></div>
            </div>
          </div>

          <div className="product-detail-info">
            <h1 className="product-detail-title">Car Battery</h1>
            <div className="product-detail-rating-row">
              ...
              <span className="product-detail-reviews">| 22 reviews</span>
            </div>
            <p className="product-detail-price">$120.00</p>
            ...
            <div className="product-detail-section">
              ...
              <p className="product-detail-section-text">Reliable battery for everyday driving and cold starts.</p>
            </div>
            ...
            <div className="product-detail-section">
              ...
              <p className="product-detail-section-text-01">Long-life battery built to deliver consistent starting power and reliability.</p>
            </div>
