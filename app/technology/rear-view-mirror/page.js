...
export default function RearViewMirrorPage(){
        ...
        <section className="product-detail">
          <div className="product-detail-image">
            <div className="product-detail-image-box">
              <img src="/building.avif" alt="Rear View Mirror" className="product-detail-img" />
            </div>
            <h2 className="quality-heading">Specification  ++</h2>
            <div className="quality-main">
              <div className="one-sp"><p className="spec-head">Type</p><p className="spec-para">Manual / Auto-dimming</p></div>
              <div className="one-sp"><p className="spec-head">Fitment</p><p className="spec-para">Universal</p></div>
              <div className="one-sp"><p className="spec-head">Feature</p><p className="spec-para">Wide angle view</p></div>
              <div className="one-sp"><p className="spec-head">Warranty</p><p className="spec-para">6 months</p></div>
            </div>
          </div>

          <div className="product-detail-info">
            <h1 className="product-detail-title">Rear View Mirror</h1>
            <div className="product-detail-rating-row">
              <span className="product-detail-stars">★★★★★</span>
              <span className="product-detail-score">4.5</span>
              <span className="product-detail-reviews">| 7 reviews</span>
            </div>
            <p className="product-detail-price">$45.00</p>
            ...
            <div className="product-detail-section">
              ...
              <p className="product-detail-section-text">Replacement rear view mirror with wide angle for safer driving.</p>
            </div>
            ...
            <div className="product-detail-section">
              ...
              <p className="product-detail-section-text-01">High quality mirror that increases field of view and reduces blind spots.</p>
            </div>
