        ...
        <section className="product-detail">
          <div className="product-detail-image">
            <div className="product-detail-image-box">
              <img src="/img1.jpeg" alt="Floor Mats" className="product-detail-img" />
            </div>
            <h2 className="quality-heading">Specification  ++</h2>
            <div className="quality-main">
              <div className="one-sp"><p className="spec-head">Material</p><p className="spec-para">Rubber / Carpet</p></div>
              <div className="one-sp"><p className="spec-head">Fitment</p><p className="spec-para">Universal / Custom</p></div>
              <div className="one-sp"><p className="spec-head">Protection</p><p className="spec-para">Waterproof</p></div>
              <div className="one-sp"><p className="spec-head">Easy Clean</p><p className="spec-para">Hose off</p></div>
            </div>
          </div>

          <div className="product-detail-info">
            <h1 className="product-detail-title">Floor Mats</h1>
            ...
            <p className="product-detail-price">$60.00</p>
            ...
            <div className="product-detail-section">
              ...
              <p className="product-detail-section-text">Durable floor mats to keep your interior clean.</p>
            </div>
            ...
            <div className="product-detail-section">
              ...
              <p className="product-detail-section-text-01">Protect your car floors with easy-to-clean floor mats built for everyday use.</p>
            </div>
