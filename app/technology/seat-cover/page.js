        ...
        <section className="product-detail">
          <div className="product-detail-image">
            <div className="product-detail-image-box">
              <img src="/img1.jpeg" alt="Seat Cover" className="product-detail-img" />
            </div>
            ...
            <div className="quality-main">
              ...
              <div className="one-sp"><p className="spec-head">Comfort</p><p className="spec-para">Padded for comfort</p></div>
              <div className="one-sp"><p className="spec-head">Maintenance</p><p className="spec-para">Wipe clean</p></div>
            </div>
          </div>

          <div className="product-detail-info">
            <h1 className="product-detail-title">Seat Cover</h1>
            <div className="product-detail-rating-row">
              ...
              <span className="product-detail-reviews">| 14 reviews</span>
            </div>
            <p className="product-detail-price">$89.00</p>
            ...
            <div className="product-detail-section">
              ...
              <p className="product-detail-section-text">Comfortable seat cover to protect and enhance your seats.</p>
            </div>
            ...
            <div className="product-detail-section">
              ...
              <p className="product-detail-section-text-01">Durable seat cover with easy install and cleaning instructions included.</p>
            </div>
