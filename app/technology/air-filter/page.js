        ...
        <section className="product-detail">
          <div className="product-detail-image">
            <div className="product-detail-image-box">
              <img src="/110.avif" alt="Air Filter" className="product-detail-img" />
            </div>
            <h2 className="quality-heading">Specification  ++</h2>
            <div className="quality-main">
              <div className="one-sp"><p className="spec-head">Material</p><p className="spec-para">High-flow paper / cotton</p></div>
              <div className="one-sp"><p className="spec-head">Fitment</p><p className="spec-para">Vehicle specific</p></div>
              <div className="one-sp"><p className="spec-head">Performance</p><p className="spec-para">Improved airflow</p></div>
              <div className="one-sp"><p className="spec-head">Maintenance</p><p className="spec-para">Replace every 12k miles</p></div>
            </div>
          </div>

          <div className="product-detail-info">
            <h1 className="product-detail-title">Air Filter</h1>
            <div className="product-detail-rating-row">
              <span className="product-detail-stars">★★★★★</span>
              <span className="product-detail-score">4.6</span>
              <span className="product-detail-reviews">| 9 reviews</span>
            </div>
            <p className="product-detail-price">$25.00</p>
            ...
            <div className="product-detail-section">
              ...
              <p className="product-detail-section-text">High-efficiency air filter for improved engine breathing.</p>
            </div>
            ...
            <div className="product-detail-section">
              ...
              <p className="product-detail-section-text-01">Premium air filter to protect your engine and improve performance.</p>
            </div>
