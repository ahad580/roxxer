        ...
        <section className="product-detail">
          <div className="product-detail-image">
            <div className="product-detail-image-box">
              <img src="/111.avif" alt="Spark Plugs" className="product-detail-img" />
            </div>
            <h2 className="quality-heading">Specification  ++</h2>
            <div className="quality-main">
              <div className="one-sp"><p className="spec-head">Type</p><p className="spec-para">Copper / Iridium</p></div>
              <div className="one-sp"><p className="spec-head">Gap</p><p className="spec-para">Standard</p></div>
              <div className="one-sp"><p className="spec-head">Performance</p><p className="spec-para">Improved ignition</p></div>
              <div className="one-sp"><p className="spec-head">Warranty</p><p className="spec-para">6 months</p></div>
            </div>
          </div>

          <div className="product-detail-info">
            <h1 className="product-detail-title">Spark Plugs</h1>
            <div className="product-detail-rating-row">
              ...
              <span className="product-detail-reviews">| 16 reviews</span>
            </div>
            <p className="product-detail-price">$30.00</p>
            ...
            <div className="product-detail-section">
              ...
              <p className="product-detail-section-text">Set of spark plugs to keep your engine firing smoothly.</p>
            </div>
            ...
            <div className="product-detail-section">
              ...
              <p className="product-detail-section-text-01">Quality spark plugs that deliver reliable ignition and improved fuel efficiency.</p>
            </div>
